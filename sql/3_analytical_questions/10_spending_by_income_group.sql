-- Q5: Spending behavior across income groups
WITH income_group_basket_stats AS (
  SELECT
    ...
    PERCENTILE_CONT(b.basket_value, 0.5)
      OVER (PARTITION BY d.income_desc) AS median_basket_value
...
FROM income_group_basket_stats
